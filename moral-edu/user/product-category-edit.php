							...
							<form method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<table class="table table-hover table-responsive">
									<tr>
										...
										<td><input class="form-control" type="text" name="ServName" placeholder="Name" value="<?php echo $sv_name; ?>" /></td>
									</tr>


									<tr>
										<td><label class="control-label">Details</label></td>
										<td><textarea id="summernote" name="Details" placeholder="Details"><?php echo $sv_details; ?></textarea></td>
									</tr>
