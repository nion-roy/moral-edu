...
$sql = "SELECT order_id,user_id,order_date, client_name, client_contact, payment_status,pre_due,today_total,grand_total, payment_status,custom_invoice_no FROM sup_orders WHERE order_status = 1  and user_id ='".$_SESSION['id']."' order by order_id desc ";
