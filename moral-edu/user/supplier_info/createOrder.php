...
//$sql1 = "DELETE FROM orders_dues WHERE sup_id = {$CustId} ";	
//$con->query($sql1);
// And INSERT/Update Same Customer Data
//mysqli_query($con,"INSERT INTO orders_dues (order_id,user_id,sup_id,order_date,last_update, client_name, client_contact,pre_due,today_total,grand_total, paid, recent_due,dues_or_paid,dues_or_paid_status,cuses)
...
mysqli_query($con,"INSERT INTO sup_orders_details (order_id,user_id,sup_id,order_date, client_name, client_contact,address,order_email,pre_due,today_total, grand_total, paid, recent_due,cuses,order_type)
