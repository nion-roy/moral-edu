...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO seo_section (user_id,title,canonical_link,type,keyword,description,author) VALUES(:user_id,:title,:canonical_link,:type,:keyword,:description,:author)');
