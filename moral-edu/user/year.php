...
<body>
	...
	<div class="col-md-2">
		<a class="btn btn-primary" href="year-add"> <span class="glyphicon glyphicon-plus"></span> Add New </a>
		<br><br>
	</div>
		...
		<tbody id="tbody">
			...
			?>
				<tr>
					...
					<td><a class="btn btn-info" href="year-edit?edit_id=<?php echo $eqrow['yer_id']; ?>" title="click for edit" onclick="return confirm('Do you want to Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
