...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i> New Invoice - - Retail Sale
		<?php } else if($_GET['o'] == 'manord') { ?>
	...
	<div class="panel-body">
		...
		<option value="#">Select Customer </option>
				      	...
				      	<?php 
				      	$sql = "SELECT  distinct client_contact,client_contact FROM orders where order_type=2 ";
		...
		<option value="#">Select Customer</option>
				      	...
				      	<?php 
				      	$sql = "SELECT  distinct client_contact,client_name FROM orders where order_type=2 ";
								$result = $con->query($sql);
			   ...
			   <div class="form-group" style="display:none;" >
			    ...
			    <div class="col-sm-10">
			     <input type="text" class="form-control" id="CustId" name="CustId" placeholder="Customer Id" value="0" autocomplete="off" />
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Customer Name" value="None" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Contact Number" value="None" autocomplete="off" />
			    </div>
			  </div>
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:8%;"><center> Stock  </center></th>
			  			<th style="width:8%;"><center> Quantity  </center></th>
			  			<th style="width:8%;"><center> Rec.Stock  </center></th>
			  			<th style="width:8%;"><center> Price </center></th>			  			
			  			<th style="width:8%;"><center> Total </center></th>			  			
			  				...
			  				<td style="margin-left:20px;">
			  					...
			  					<select class="form-control chosen-select " name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)" >
			  						...
			  						<?php
										...
										$productSql = "SELECT * FROM product WHERE user_id='".$_SESSION['id']."' order by id asc";
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			...
			FROM orders  WHERE orders.order_id = {$orderId}";
             ...
             <div class="form-group">
			    <label for="orderId" class="col-sm-2 control-label">Cutomer Id </label>
			    <div class="col-sm-10">
			  ...
			  <table class="table" id="productTable">
			  	<thead>
			             <th style="width:40%;"> Product </th>
			  			...
			  			<th style="width:15%;"><center> Quantty </center></th>			  			
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				...
			  				<td style="padding-left:20px;">			  					
			  					<input type="text" name="rate[]" id="rate<?php echo $x; ?>" class="form-control" value="<?php echo $orderItemData['rate']; ?>" />			  					
...
<script>
	$("#loadCustomer").on("click", function(){
		...
		if(customerID == "")
		{
			...
			$.ajax({url: "ajax_c_load_retail.php?c=" + customerID, success: function(result){
