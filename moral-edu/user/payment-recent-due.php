...
<center><h4><ol class="breadcrumb"> <li class="active">Students Dues - Only Dues </li></ol></h4></center>
...
<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-info" style="width:100%" href="payment-details"> <span class="glyphicon glyphicon-eye-open"></span> View Details </a> 
		</div>
		
		<div class="col-md-2">
		<a class="btn btn-warning" style="width:100%" href="payment"> <span class="glyphicon glyphicon-eye-open"></span> View Main Dues</a> 
		</div>
		 -->
		<!--	
		<div class="col-md-2">
