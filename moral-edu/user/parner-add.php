...
<body>
	...
	if (isset($_POST['btnsave'])) {
		...
		if (!isset($errMSG)) {
			$stmt = $DB_con->prepare('INSERT INTO parner (user_id,pr_name,pr_details,userPic) 
															VALUES(:user_id,:ParName,:Details,:upic)');
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			<h1>Add New Parner | <span> <a href="parner"> <i class="bi bi-table"></i> </a> </span> </h1>
			<hr>
		</div>
							...
							<form method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<table class="table table-hover table-responsive">
									...
									<tr>
										...
										<td><input class="form-control" type="text" name="ParName" placeholder="Name" value="<?php echo $ParName; ?>" /></td>
									</tr>

									<tr>
										<td><label class="control-label"> Details </label></td>
										<td><textarea name="Details" placeholder="Details" style="width:100%;">Na</textarea></td>
									</tr>
