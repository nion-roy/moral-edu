...
<body>
	...
	<center>
		<h3>
			<ol class="breadcrumb">
				<li class="active">About Section Update</li>
			</ol>
		</h3>
	</center>
		...
		<form method="post" enctype="multipart/form-data" class="form-horizontal">
			...
			<table class="table table-hover table-responsive">
				...
				<tr>
					...
					<td><textarea style="height:150px; width:100%;" class="form-control" name="AboutSubTitle" placeholder="Please Write Here "><?php echo $about_subtitle; ?></textarea></td>
				</tr>
			...
			<a class="btn btn-danger" href="about-section"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
