          ...
          <div class="card">
			...
			?>
				<tr>
					...
					<td><a class="btn btn-info" href="map-edit?edit_id=<?php echo $eqrow['mp_id']; ?>" title="click for edit" onclick="return confirm('Do you want to Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
