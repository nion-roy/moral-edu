            ...
            <div class="card-body">
              ...
              <table class="table table-hover datatable">
                ...
                <tbody id="tbody">
                  <?php
                  $sl = 0;
                  $eq = mysqli_query($con, "select * from blog_section where user_id='" . $_SESSION['id'] . "' ORDER BY id asc");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a class="btn btn-info" href="blog-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Are You Sure To Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
