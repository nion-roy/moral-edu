...
<div style="font-size:30px;font-weight:bold;">Invoice</div>
 <div>Invoice No : <b>itm-<?php echo $pqrow['custom_invoice_no']; ?> </b><br> 
	Date : <?php echo date("d-M-Y", strtotime($pqrow['order_date'])); ?></div>
 </div> 
  ...
  Invoice To,<br>
   <?php 
				   ...
				   while($pqrow=mysqli_fetch_array($pq)){
				?> 
			   <div><b><?php echo $pqrow['client_name']; ?></b></div>
			   <div> Phone : <?php echo $pqrow['client_contact']; ?></div> 
			   <div> Email : <?php echo $pqrow['order_email']; ?></div> 
			   <div> Address : <?php echo $pqrow['address']; ?></div> 
	<?php }?>
  </div>
...
<table border="0" cellpadding="5" style="width:100%;float:left;border:1px solid black;border-top-style:1px solid black;border-bottom-style:1px solid black;">
	...
	<tbody>
		<tr>
			...
			<th style="text-align:left;"><p1 style="font-size:15;">Course </p1> </th>
			<th><p1 style="font-size:15;">Qty </p1></th>
			<th><p1 style="font-size:15;">Fee </p1></th>
...
?>
<div id="remark" style="width:100%;float:left;text-align:center;border:1px solid gray;margin-top:50px;margin-bottom:50px;"> 
<p style="padding:10px;">Thanks For Training With Us</p>
</div> 
<div style="float:left; text-align:center;">........................................<br>Student Signature</div> 
<div style="float:right;text-align:center;">........................................<br>Institute Signature</div>
</div>
