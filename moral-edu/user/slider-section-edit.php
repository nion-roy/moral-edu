...
?>
			<script>
				...
				window.location.href = 'slider-section';
			</script>
<?php
		} else {
...
<body>
	...
	<center>
		<h3>
			<ol class="breadcrumb">
				<li class="active">Slider Section Update</li>
			</ol>
		</h3>
	</center>
...
<table class="table table-hover table-responsive">
			...
			<tr>
				<td colspan="2"><button type="submit" name="btn_save_updates" class="btn btn-primary">
					...
					<a class="btn btn-danger" href="slider-section"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
