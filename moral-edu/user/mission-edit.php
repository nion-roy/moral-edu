...
<body>
	...
	if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM mission WHERE ms_id =:uid');
	...
	if (isset($_POST['btn_save_updates'])) {
		...
		if (!isset($errMSG)) {
			$stmt = $DB_con->prepare('UPDATE mission 
									     SET  name =:Name,
											  details=:Details,
							...
							<form method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<tr>
									<td colspan="2"><button type="submit" name="btn_save_updates" class="btn btn-primary">
										...
										<a class="btn btn-danger" href="mission"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
