...
<body>
	...
	<!-- <h1 class="h2">&nbsp;<a class="btn btn-primary" href="upazilla_add.php"> <span class="glyphicon glyphicon-plus"></span>Add New</a>
		<a class="btn btn-success" href="upazilla.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View</a></h1>
