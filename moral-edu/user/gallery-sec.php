...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
     <h1>Gallery |  <span> <a href="gallery-sec-add">   <i class="bi bi-plus-square-fill"></i> </a> </span> </h1>
       <hr>
    </div> 
          ...
          <div class="card">
			...
			?>
				<tr>
					...
					<td><a class="btn btn-success" href="gallery-sec-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Are You Sure To Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
