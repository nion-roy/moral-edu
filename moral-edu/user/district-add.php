...
<body>
	...
	<!-- <h1 class="h2">&nbsp;<a class="btn btn-primary" href="district-add"> <span class="glyphicon glyphicon-plus"></span>Add New</a>
		<a class="btn btn-success" href="district"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View</a></h1>
