...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>FAQ Lists | <span> <a href="faq-add"> <i class="bi bi-plus-square-fill"></i> </a> </span> </h1>
      <hr>
    </div>
                ...
                <tbody id="tbody">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a class="btn btn-info" href="faq-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Are You Sure To Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
