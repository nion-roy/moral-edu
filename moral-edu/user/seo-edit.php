...
<body>
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE seo_section SET title= :Title, canonical_link = :CanonicalLink,  type = :Category, keyword = :Keyword, description = :Description, author = :Author WHERE id = :uid');
