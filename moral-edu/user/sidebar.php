<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <?php
    $home = ['slider', 'slider-add', 'slider-edit', 'why', 'why-add', 'why-edit', 'faq', 'faq-add', 'faq-edit', 'stats', 'Stats-add', 'stats-edit', 'parner', 'parner-add', 'parner-edit'];
    ?>
    <li class="nav-item">
      ...
      <ul id="home" class="nav-content collapse  <?= is_numeric(array_search($activePage, $home)) ? 'show' : ''; ?>" data-bs-parent="#sidebar-nav">
        <li><a href="slider" class="<?= ($activePage == 'slider' ||  $activePage == 'service-add' ||  $activePage == 'slider-edit') ? 'active' : ''; ?>"><i class="bi bi-bookmarks-fill"></i><span> Slider </span> </a> </li>
        <li><a href="why" class="<?= ($activePage == 'why' ||  $activePage == 'why-add' ||  $activePage == 'why-edit') ? 'active' : ''; ?>"><i class="bi bi-geo-alt-fill"></i><span> Why Chose </span> </a> </li>
        <li><a href="faq" class="<?= ($activePage == 'faq' ||  $activePage == 'faq-add' ||  $activePage == 'faq-edit') ? 'active' : ''; ?>"><i class="bi bi-geo-alt-fill"></i><span> FAQ </span> </a> </li>
    ...
    <?php $about_arr = ['web-about-sec', 'team', 'add-team', 'edit-team', 'teacher', 'add-teacher', 'edit-teacher', 'testimonial', 'Testimonial-add', 'testimonial-edit', 'mission', 'Mission-add', 'mission-edit', 'vision', 'Vision-add', 'vision-edit', 'success-student', 'success-student-add', 'success-student-edit'] ?>
    ...
    <li class="nav-item">
      ...
      <ul id="Website" class="nav-content collapse <?= is_numeric(array_search($activePage, $about_arr)) ? 'show' : ''; ?>" data-bs-parent="#sidebar-nav">
        ...
        <li><a href="teacher" class="<?= ($activePage == 'teacher' ||  $activePage == 'add-teacher' ||  $activePage == 'edit-teacher') ? 'active' : ''; ?>"><i class="bi bi-people-fill"></i><span> Our Teacher </span> </a> </li>
        ...
        <li><a href="success-student" class="<?= ($activePage == 'success-student' ||  $activePage == 'success-student-add' ||  $activePage == 'success-student-edit') ? 'active' : ''; ?>"><i class="bi bi-images"></i><span> Success Students </span> </a> </li>
      </ul>
    </li>
    ...
    <li class="nav-item"><a href="contact-list" class="nav-link collapsed <?= ($activePage == 'contact-list') ? 'active' : ''; ?>"><i class="bi bi-list"></i><span> Contact List </span> </a> </li>

    <li class="nav-item"><a href="course-apply-list" class="nav-link collapsed <?= ($activePage == 'course-apply-list') ? 'active' : ''; ?>"><i class="bi bi-list"></i><span> Course Apply List </span> </a> </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed <?= is_numeric(array_search($activePage, $service_arr)) ? 'active' : ''; ?>" data-bs-target="#news" data-bs-toggle="collapse" href="#">
        <i class="bi bi-book-half"></i><span>News / Notice / Blog </span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed <?= ($activePage == 'seo') ? 'active' : ''; ?>" href="seo">
    ...
    <li class="nav-heading">Accounting Part</li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed <?= ($activePage == 'student-list' || $activePage == 'add-student' || $activePage == 'edit-student' || $activePage == 'details-student' || $activePage == 'batch-list' || $activePage == 'add-batch' || $activePage == 'edit-batch' || $activePage == 'degree-list' || $activePage == 'add-degree' || $activePage == 'edit-degree' ||
        ...
        <i class="bi bi-people-fill"></i><span>Students List</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
