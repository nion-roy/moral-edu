...
<body>
	...
	if (isset($_POST['btnsave'])) {
		...
		if (!isset($errMSG)) {
			$stmt = $DB_con->prepare('INSERT INTO service (user_id,sv_name,sv_details,userPic) 
															VALUES(:user_id,:ServName,:Details,:upic)');
							...
							<form method="post" enctype="multipart/form-data" class="form-horizontal">
								...
								<table class="table table-hover table-responsive">
									...
									<tr>
										...
										<td><input class="form-control" type="text" name="ServName" placeholder="Service Name" value="<?php echo $ServName; ?>" /></td>
									</tr>
