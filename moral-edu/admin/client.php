    ...
    <div id="wrapper">
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="page-header">Client List
			 ...
			 <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#adddealer"><i class="fa fa-plus-circle"></i> Add New Stuff</button>
                ...
                <div class="col-lg-12">
                   <table width="100%" class="table  table-bordered " id="dataTables-example">
                        ...
                        <tbody>
							<?php
								$dq=mysqli_query($con,"select * from stuff left join `user` on user.userid=stuff.userid  where stuff.status='1' order by stuff.userid asc ");
							...
							<!--			<button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delemp_<?php echo $did; ?>"><i class="fa fa-trash"></i> Delete </button> -->
										...
										<?php include('client_edit_details_modal.php'); ?>
									</td>
								</tr>
								<?php
								}
