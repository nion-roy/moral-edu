<?php
	...
	mysqli_query($con,"update stuff set stuff_name='$StuffName',position='$Position',contact_info='$contact',
	                                   business_name='$BizName',service_charge='$ServCharg',business_phone='$BizPhone',business_email='$BizEmail',business_address='$BizAddress',invoice_welcome='$InvWelcome',
	                                   photo='$location', status='$Status', software_status='$Type',comments='$Comments'
