...
<center><h4><ol class="breadcrumb"> <li class="active">District </li></ol></h4></center>	
	  <div style="width:100%" class="form-group input-group">
    	...
    	<h1 class="h2">
		<a class="btn btn-default" href="district_add.php"> <span class="glyphicon glyphicon-plus"></span>   Add New  </a> 
		<a target="_blank" class="btn btn-success" href="dist_report.php"> <span class="glyphicon glyphicon-file"></span> Report</a>
		 </h1> 
...
<table width="100%" class="table table-striped table-bordered table-hover" group_id="dataTables-example">
				...
				<td><a  class="btn btn-info" href="district_edit.php?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" 
