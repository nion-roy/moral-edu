...
<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		$stmt_delete = $DB_con->prepare('DELETE FROM division WHERE id =:uid');
...
<center><h4><ol class="breadcrumb"> <li class="active">Division </li></ol></h4></center>	
	  <div style="width:100%" class="form-group input-group">
    	...
    	<h1 class="h2">
		<a class="btn btn-default" href="area_add.php"> <span class="glyphicon glyphicon-plus"></span>Add New  </a> 
		<a target="_blank" class="btn btn-success" href="area_report.php"> <span class="glyphicon glyphicon-file"></span> Report</a> 
		 </h1> 
...
<table width="100%" class="table table-striped table-bordered table-hover" group_id="dataTables-example">
                        ...
                        <tbody id="tbody">
							<?php
								$eq=mysqli_query($con,"select * from division  ORDER BY id DESC ");
								while($eqrow=mysqli_fetch_array($eq)){
									...
									?>
										<tr>
											...
											<td><?php echo $eqrow['area_name']; ?></td>
											 
											
				<td><a  class="btn btn-info" href="area_edit.php?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" 
