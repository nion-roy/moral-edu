...
//	mysqli_query($con,"insert into `user_backup` (userid, username,password,access_level) values ('$uid','$username','$password','4')");
	...
	mysqli_query($con,"insert into stuff (userid,stuff_name,position,contact_info,business_name,service_charge,business_phone,business_email,business_address,invoice_welcome,join_date,status,software_status,comments,division_id,district_id,upazila_id,photo) 
					values ('$uid','$StuffName','$Position','$contact','$BizName','$ServCharg','$BizPhone','$BizEmail','$BizAddress','$InvWelcome','$joindate','1','$Type','$Comments','$Division','$District','$Upazila','$location')");
