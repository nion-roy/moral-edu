            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
					...
					<span style="color:blue; font-size:18px;"><img src="includes/itm-dtcms.png" width="150px" /></span>
                        ...
                        <h4 class="alert alert-danger pt-4" style="width:100%;"> Please Pay Your <b style="color:red;">Due Amount</b> ! And Then You Can Alow To <b style="color:green;">Use Software</b>. Or, Contact With Us </h4>
                        <h2>  </h2>  
