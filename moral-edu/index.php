      ...
      <div class="workinghny-form-grid">
        <div class="main-mockup">
          ...
          <div class="w3l_form align-self">
            <img src="login/images/itm-soft-user.png" width="100%">
          </div>
          <div class="content-wthree text-center">
            <div style="margin-top:20px;margin-bottom:20px;">
              <img src="includes/itm-dtcms.png" width="150px" />
              <br>
              <h2>Digital Training Center</h2>
              <p>A Smart CRM For Training Center</p>
            </div>
