          ...
          <div class="search-right">
            ...
            <div id="search" class="pop-overlay">
              <div class="popup">
                ...
                <form action="https://p.w3layouts.com/demos_new/template_demo/20-10-2021/online-study-liberty-demo_Free/676477441/web/error.php" method="GET" class="search-box">
                  <div class="input-search"> <span class="fa fa-search mr-2" aria-hidden="true"></span><input type="search" placeholder="Enter Keyword" name="search" required="required" autofocus="">
                  </div>
